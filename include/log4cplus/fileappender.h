...
namespace log4cplus
{
    ...
    protected:
      ...
      // Data
        ...
        /**
         * When appending multilined logs to file, the OS can modify the
         * end-of-line chars.  If the OS is Windows, end-of-line will be
         * overriden to "\r\n".  When FileAppender's property
         * <code>TextMode</code> is set to <code>Binary</code>, then bool
         * attribute <code>binaryTextMode</code> is true, and the OS will not
         * intervene.  By default, <code>binaryTextMode</code> is false.
         */
        bool binaryTextMode;
