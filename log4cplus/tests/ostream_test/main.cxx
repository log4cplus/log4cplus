...
main()
{
    ...
    LOG4CPLUS_DEBUG(test, "This is a bool: " << boolalpha << true);
    ...
    LOG4CPLUS_INFO(test, "This is a long(hex): " << hex << (long)123456789);
    LOG4CPLUS_INFO(test, "This is a long(oct): " << oct << (long)123456789);
